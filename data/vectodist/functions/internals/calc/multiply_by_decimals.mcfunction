...
scoreboard players operation temp_x vtd *= nx_0 vtd
scoreboard players operation temp_y vtd *= ny_0 vtd
scoreboard players operation temp_z vtd *= nz_0 vtd
...
scoreboard players operation temp_x vtd /= 100000000 vtd
scoreboard players operation temp_y vtd /= 100000000 vtd
scoreboard players operation temp_z vtd /= 100000000 vtd
scoreboard players operation mx vtd += temp_x vtd
scoreboard players operation my vtd += temp_y vtd
scoreboard players operation mz vtd += temp_z vtd